...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ mdxComponents_LiveProvider)
});
...
var lib = __webpack_require__(460);
...
// EXTERNAL MODULE: ./node_modules/gatsby/node_modules/core-js/features/object/assign.js
var object_assign = __webpack_require__(2941);
...
var CodeEditor = function CodeEditor(props) {
            ...
            return (
              ...
              index_js_default().createElement(
                ...
                line.map(function (token, key) {
                  return (
                    // eslint-disable-next-line react/jsx-key
                    index_js_default().createElement('span', getTokenProps({ token: token, key: key }))
                  );
                })
              )
            );
  ...
  return index_js_default().createElement(lib/* default */.Z, _extends({
    value: code,
    padding: 10,
...
var LiveContext = (0,index_js_.createContext)({});
...
var errorBoundary = function errorBoundary(Element, errorCallback) {
  return function (_Component) {
    ...
    ErrorBoundary.prototype.render = function render() {
      return typeof Element === 'function' ? index_js_default().createElement(Element, null) : Element;
    };
...
var evalCode = function evalCode(code, scope) {
  ...
  return res.apply(undefined, [_poly, (index_js_default())].concat(scopeValues));
};
...
function LiveEditor(props) {
  var _useContext = (0,index_js_.useContext)(LiveContext),
  ...
  return index_js_default().createElement(CodeEditor, _extends({
    theme: theme,
    code: code,
    language: language,
    disabled: disabled,
...
function LiveError(props) {
  ...
  return error ? index_js_default().createElement(
    'pre',
    props,
    error
  ) : null;
...
function LivePreview(_ref) {
  ...
  return index_js_default().createElement(
    Component$$1,
    rest,
    Element ? index_js_default().createElement(Element, null) : null
  );
}
...
;// CONCATENATED MODULE: ./src/components/mdxComponents/LiveProvider.js
const ReactLiveProvider=({code})=>{return (0,emotion_react_esm/* jsx */.tZ)(LiveProvider,{code:code},(0,emotion_react_esm/* jsx */.tZ)(LiveEditor,null),(0,emotion_react_esm/* jsx */.tZ)(LiveError,null),(0,emotion_react_esm/* jsx */.tZ)(LivePreview,null));};/* harmony default export */ const mdxComponents_LiveProvider = (ReactLiveProvider);
...
var path = __webpack_require__(9612);
...
var parent = __webpack_require__(1226);
...
var isCallable = __webpack_require__(6690);
var tryToString = __webpack_require__(9705);
...
var isObject = __webpack_require__(2933);
...
var toIndexedObject = __webpack_require__(8314);
var toAbsoluteIndex = __webpack_require__(7580);
var lengthOfArrayLike = __webpack_require__(8551);
...
var hasOwn = __webpack_require__(6391);
var ownKeys = __webpack_require__(5107);
var getOwnPropertyDescriptorModule = __webpack_require__(8601);
var definePropertyModule = __webpack_require__(2125);
...
var DESCRIPTORS = __webpack_require__(4691);
var definePropertyModule = __webpack_require__(2125);
var createPropertyDescriptor = __webpack_require__(1771);
...
var fails = __webpack_require__(3235);
...
var global = __webpack_require__(4075);
var isObject = __webpack_require__(2933);
...
var getBuiltIn = __webpack_require__(3409);
...
var global = __webpack_require__(4075);
var userAgent = __webpack_require__(1391);
...
var global = __webpack_require__(4075);
var getOwnPropertyDescriptor = __webpack_require__(8601).f;
var createNonEnumerableProperty = __webpack_require__(2921);
var redefine = __webpack_require__(4089);
var setGlobal = __webpack_require__(8878);
var copyConstructorProperties = __webpack_require__(3826);
var isForced = __webpack_require__(5243);
...
var aCallable = __webpack_require__(5907);
...
var toObject = __webpack_require__(8415);
...
var DESCRIPTORS = __webpack_require__(4691);
var fails = __webpack_require__(3235);
var createElement = __webpack_require__(2035);
...
var fails = __webpack_require__(3235);
var classof = __webpack_require__(9035);
...
var isCallable = __webpack_require__(6690);
var store = __webpack_require__(1284);
...
var NATIVE_WEAK_MAP = __webpack_require__(5727);
var global = __webpack_require__(4075);
var isObject = __webpack_require__(2933);
var createNonEnumerableProperty = __webpack_require__(2921);
var hasOwn = __webpack_require__(6391);
var shared = __webpack_require__(1284);
var sharedKey = __webpack_require__(5746);
var hiddenKeys = __webpack_require__(1985);
...
var toLength = __webpack_require__(4035);
...
var V8_VERSION = __webpack_require__(1080);
var fails = __webpack_require__(3235);
...
var global = __webpack_require__(4075);
var isCallable = __webpack_require__(6690);
var inspectSource = __webpack_require__(2152);
...
var DESCRIPTORS = __webpack_require__(4691);
var fails = __webpack_require__(3235);
var objectKeys = __webpack_require__(8992);
var getOwnPropertySymbolsModule = __webpack_require__(9140);
var propertyIsEnumerableModule = __webpack_require__(6209);
var toObject = __webpack_require__(8415);
var IndexedObject = __webpack_require__(8266);
...
var DESCRIPTORS = __webpack_require__(4691);
var IE8_DOM_DEFINE = __webpack_require__(5659);
var anObject = __webpack_require__(1237);
var toPropertyKey = __webpack_require__(5740);
...
var internalObjectKeys = __webpack_require__(5129);
var enumBugKeys = __webpack_require__(9526);
...
var hasOwn = __webpack_require__(6391);
var toIndexedObject = __webpack_require__(8314);
var indexOf = __webpack_require__(3999).indexOf;
var hiddenKeys = __webpack_require__(1985);
...
var getBuiltIn = __webpack_require__(3409);
var getOwnPropertyNamesModule = __webpack_require__(6483);
var getOwnPropertySymbolsModule = __webpack_require__(9140);
var anObject = __webpack_require__(1237);
...
var setGlobal = __webpack_require__(8878);
var inspectSource = __webpack_require__(2152);
var InternalStateModule = __webpack_require__(278);
var CONFIGURABLE_FUNCTION_NAME = __webpack_require__(946).CONFIGURABLE;
...
var shared = __webpack_require__(9709);
var uid = __webpack_require__(6819);
...
var IS_PURE = __webpack_require__(9953);
var store = __webpack_require__(1284);
...
var IndexedObject = __webpack_require__(8266);
var requireObjectCoercible = __webpack_require__(8956);
...
var isObject = __webpack_require__(2933);
var isSymbol = __webpack_require__(5970);
var getMethod = __webpack_require__(7946);
var ordinaryToPrimitive = __webpack_require__(2835);
var wellKnownSymbol = __webpack_require__(1487);
...
/* eslint-disable es/no-symbol -- required for testing */
var NATIVE_SYMBOL = __webpack_require__(1782);
...
var $ = __webpack_require__(8845);
var assign = __webpack_require__(2280);
