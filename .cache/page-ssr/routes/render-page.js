...
],links:[{text:'Hasura',link:'https://hasura.io'}],frontline:false,ignoreIndex:true,title:"<a href='https://hasura.io/learn/'>graphql </a><div class='greenCircle'></div><a href='https://hasura.io/learn/graphql/react/introduction/'>react</a>"},siteMetadata:{title:'Gatsby Gitbook Boilerplate | Hasura',description:'Documentation built with mdx. Powering hasura.io/learn ',ogImage:null,docsLocation:'https://github.com/hasura/gatsby-gitbook-boilerplate/tree/master/content',favicon:'https://graphql-engine-cdn.hasura.io/img/hasura_icon_black.svg'},pwa:{enabled:false,// disabling this will also remove the existing service worker.
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-94f96524d21b228bf347.js"],"app":["/app-05ef863ecaa5368cd64a.js"],"component---src-templates-docs-js":[]}');
