...
/* harmony export */ });
/* harmony import */ var _algolia_client_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9611);
/* harmony import */ var _algolia_transporter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(687);
/* harmony import */ var _algolia_requester_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9854);
...
/* harmony export */ });
/* harmony import */ var _algolia_client_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9611);
/* harmony import */ var _algolia_transporter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(687);
/* harmony import */ var _algolia_requester_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9854);
/* harmony import */ var crypto__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4347);
...
/* harmony export */ });
/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9872);
/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(http__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9835);
...
/* harmony export */ });
/* harmony import */ var _algolia_requester_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9854);
...
var cacheCommon = __webpack_require__(8465);
var cacheInMemory = __webpack_require__(7385);
var clientAnalytics = __webpack_require__(8110);
var clientCommon = __webpack_require__(9611);
var clientPersonalization = __webpack_require__(1565);
var clientSearch = __webpack_require__(7963);
var loggerCommon = __webpack_require__(6525);
var requesterNodeHttp = __webpack_require__(5205);
var transporter = __webpack_require__(687);
...
const algoliasearch = __webpack_require__(3396);
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ SearchComponent)
});

// NAMESPACE OBJECT: ./src/components/search/hitComps.js
var hitComps_namespaceObject = {};
__webpack_require__.r(hitComps_namespaceObject);
__webpack_require__.d(hitComps_namespaceObject, {
  "PageHit": () => (PageHit)
});
...
var instantSearchContext = /*#__PURE__*/(0,index_js_.createContext)({
...
var _createContext = /*#__PURE__*/(0,index_js_.createContext)(undefined),
...
function createConnector_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function createConnector_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { createConnector_ownKeys(Object(source), true).forEach(function (key) { (0,defineProperty/* default */.Z)(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { createConnector_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
  ...
  return function (Composed) {
    var Connector = /*#__PURE__*/function (_Component) {
      ...
      function Connector(props) {
        ...
        (0,defineProperty/* default */.Z)(_assertThisInitialized(_this), "unsubscribe", void 0);

        (0,defineProperty/* default */.Z)(_assertThisInitialized(_this), "unregisterWidget", void 0);

        (0,defineProperty/* default */.Z)(_assertThisInitialized(_this), "isUnmounting", false);

        (0,defineProperty/* default */.Z)(_assertThisInitialized(_this), "state", {
          providedProps: _this.getProvidedProps(_this.props)
        });

        (0,defineProperty/* default */.Z)(_assertThisInitialized(_this), "refine", function () {
          var _ref;
        ...
        (0,defineProperty/* default */.Z)(_assertThisInitialized(_this), "createURL", function () {
          var _ref2;
        ...
        (0,defineProperty/* default */.Z)(_assertThisInitialized(_this), "searchForFacetValues", function () {
          var _ref3;
      ...
      _createClass(Connector, [{
        ...
        value: function componentWillUnmount() {
          ...
          if (this.unregisterWidget) {
            ...
            if (typeof connectorDesc.cleanUp === 'function') {
              ...
              this.props.contextValue.store.setState(createConnector_objectSpread(createConnector_objectSpread({}, this.props.contextValue.store.getState()), {}, {
                widgets: nextState
              }));
        ...
        value: function render() {
          ...
          return /*#__PURE__*/index_js_default().createElement(Composed, (0,esm_extends/* default */.Z)({}, props, providedProps, refineProps, searchForFacetValuesProps));
        }
      }]);
    ...
    (0,defineProperty/* default */.Z)(Connector, "displayName", "".concat(connectorDesc.displayName, "(").concat(getDisplayName(Composed), ")"));

    (0,defineProperty/* default */.Z)(Connector, "propTypes", connectorDesc.propTypes);

    (0,defineProperty/* default */.Z)(Connector, "defaultProps", connectorDesc.defaultProps);
...
var createConnectorWithContext = function createConnectorWithContext(connectorDesc) {
  return function (Composed) {
    ...
    var ConnectorWrapper = function ConnectorWrapper(props) {
      return /*#__PURE__*/index_js_default().createElement(InstantSearchConsumer, null, function (contextValue) {
        return /*#__PURE__*/index_js_default().createElement(IndexConsumer, null, function (indexContextValue) {
          return /*#__PURE__*/index_js_default().createElement(Connector, (0,esm_extends/* default */.Z)({
...
/* harmony default export */ const createConnector = (createConnectorWithContext);
;// CONCATENATED MODULE: ./node_modules/react-instantsearch-core/dist/es/core/indexUtils.js


function indexUtils_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function indexUtils_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { indexUtils_ownKeys(Object(source), true).forEach(function (key) { (0,defineProperty/* default */.Z)(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { indexUtils_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
function refineMultiIndex(searchState, nextRefinement, indexId, resetPage) {
  ...
  var state = searchState.indices && searchState.indices[indexId] ? indexUtils_objectSpread(indexUtils_objectSpread({}, searchState.indices), {}, (0,defineProperty/* default */.Z)({}, indexId, indexUtils_objectSpread(indexUtils_objectSpread(indexUtils_objectSpread({}, searchState.indices[indexId]), nextRefinement), page))) : indexUtils_objectSpread(indexUtils_objectSpread({}, searchState.indices), {}, (0,defineProperty/* default */.Z)({}, indexId, indexUtils_objectSpread(indexUtils_objectSpread({}, nextRefinement), page)));
  return indexUtils_objectSpread(indexUtils_objectSpread({}, searchState), {}, {
    indices: state
  });
}
...
function refineSingleIndex(searchState, nextRefinement, resetPage) {
  ...
  return indexUtils_objectSpread(indexUtils_objectSpread(indexUtils_objectSpread({}, searchState), nextRefinement), page);
}
...
function refineMultiIndexWithNamespace(searchState, nextRefinement, indexId, resetPage, namespace) {
  ...
  var state = searchState.indices && searchState.indices[indexId] ? indexUtils_objectSpread(indexUtils_objectSpread({}, searchState.indices), {}, (0,defineProperty/* default */.Z)({}, indexId, indexUtils_objectSpread(indexUtils_objectSpread({}, searchState.indices[indexId]), {}, (_objectSpread4 = {}, (0,defineProperty/* default */.Z)(_objectSpread4, namespace, indexUtils_objectSpread(indexUtils_objectSpread({}, searchState.indices[indexId][namespace]), nextRefinement)), (0,defineProperty/* default */.Z)(_objectSpread4, "page", 1), _objectSpread4)))) : indexUtils_objectSpread(indexUtils_objectSpread({}, searchState.indices), {}, (0,defineProperty/* default */.Z)({}, indexId, indexUtils_objectSpread((0,defineProperty/* default */.Z)({}, namespace, nextRefinement), page)));
  return indexUtils_objectSpread(indexUtils_objectSpread({}, searchState), {}, {
    indices: state
  });
}
...
function refineSingleIndexWithNamespace(searchState, nextRefinement, resetPage, namespace) {
  ...
  return indexUtils_objectSpread(indexUtils_objectSpread({}, searchState), {}, (0,defineProperty/* default */.Z)({}, namespace, indexUtils_objectSpread(indexUtils_objectSpread({}, searchState[namespace]), nextRefinement)), page);
}
...
function cleanUpValueWithSingleIndex(_ref3) {
  ...
  if (namespace) {
    return indexUtils_objectSpread(indexUtils_objectSpread({}, searchState), {}, (0,defineProperty/* default */.Z)({}, namespace, omit(searchState[namespace], [attribute])));
  }
...
function cleanUpValueWithMultiIndex(_ref4) {
  ...
  if (namespace && indexSearchState) {
    return indexUtils_objectSpread(indexUtils_objectSpread({}, searchState), {}, {
      indices: indexUtils_objectSpread(indexUtils_objectSpread({}, searchState.indices), {}, (0,defineProperty/* default */.Z)({}, indexId, indexUtils_objectSpread(indexUtils_objectSpread({}, indexSearchState), {}, (0,defineProperty/* default */.Z)({}, namespace, omit(indexSearchState[namespace], [attribute])))))
    });
  }

  if (indexSearchState) {
    return indexUtils_objectSpread(indexUtils_objectSpread({}, searchState), {}, {
      indices: indexUtils_objectSpread(indexUtils_objectSpread({}, searchState.indices), {}, (0,defineProperty/* default */.Z)({}, indexId, omit(indexSearchState, [id])))
    });
  }

  return searchState;
}
;// CONCATENATED MODULE: ./node_modules/react-instantsearch-core/dist/es/connectors/connectStateResults.js
...
/* harmony default export */ const connectStateResults = (createConnector({
...
/* harmony default export */ const version = ('6.13.0');
;// CONCATENATED MODULE: ./node_modules/react-instantsearch-core/dist/es/core/createInstantSearchManager.js


var createInstantSearchManager_excluded = ["resultsFacetValues"],
    _excluded2 = ["resultsFacetValues"],
    _excluded3 = ["resultsFacetValues"];

function createInstantSearchManager_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function createInstantSearchManager_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { createInstantSearchManager_ownKeys(Object(source), true).forEach(function (key) { (0,defineProperty/* default */.Z)(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { createInstantSearchManager_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
function addAlgoliaAgents(searchClient) {
  if (typeof searchClient.addAlgoliaAgent === 'function') {
    searchClient.addAlgoliaAgent("react (".concat(index_js_.version, ")"));
...
function createInstantSearchManager(_ref) {
  ...
  var helper = algoliasearch_helper_default()(searchClient, indexName, createInstantSearchManager_objectSpread({}, HIGHLIGHT_TAGS));
  ...
  function getSearchParameters() {
    ...
    .sort(sortIndexWidgetsFirst).reduce(function (indices, widget) {
      ...
      return createInstantSearchManager_objectSpread(createInstantSearchManager_objectSpread({}, indices), {}, (0,defineProperty/* default */.Z)({}, indexId, widgets.concat(widget)));
    }, {});
  ...
  function handleSearchSuccess(_ref3) {
    ...
    return function (event) {
      ...
      if (!isDerivedHelpersEmpty) {
        results = createInstantSearchManager_objectSpread(createInstantSearchManager_objectSpread({}, results), {}, (0,defineProperty/* default */.Z)({}, indexId, event.results));
      } else {
      ...
      var resultsFacetValues = currentState.resultsFacetValues,
          partialState = (0,objectWithoutProperties/* default */.Z)(currentState, createInstantSearchManager_excluded);

      store.setState(createInstantSearchManager_objectSpread(createInstantSearchManager_objectSpread({}, partialState), {}, {
        results: results,
  ...
  function handleSearchError(_ref4) {
    ...
    var resultsFacetValues = currentState.resultsFacetValues,
        partialState = (0,objectWithoutProperties/* default */.Z)(currentState, _excluded2);
    ...
    if (!stalledSearchTimer) {
      stalledSearchTimer = setTimeout(function () {
        var _store$getState = store.getState(),
            ...
            partialState = (0,objectWithoutProperties/* default */.Z)(_store$getState, _excluded3);
    ...
    if (client.transporter && !client._cacheHydrated) {
      ...
      client.search = function (requests) {
        ...
        var requestsWithSerializedParams = requests.map(function (request) {
          return createInstantSearchManager_objectSpread(createInstantSearchManager_objectSpread({}, request), {}, {
  ...
  function hydrateSearchClientWithMultiIndexRequest(client, results) {
    ...
    client.cache = createInstantSearchManager_objectSpread(createInstantSearchManager_objectSpread({}, client.cache), {}, (0,defineProperty/* default */.Z)({}, key, JSON.stringify({
      results: results.reduce(function (acc, result) {
        return acc.concat(result.rawResults);
      }, [])
    })));
  ...
  function hydrateResultsState(results) {
    ...
    if (Array.isArray(results.results)) {
      return results.results.reduce(function (acc, result) {
        return createInstantSearchManager_objectSpread(createInstantSearchManager_objectSpread({}, acc), {}, (0,defineProperty/* default */.Z)({}, result._internalIndexId, new (algoliasearch_helper_default()).SearchResults(new (algoliasearch_helper_default()).SearchParameters(result.state), result.rawResults)));
      }, {});
    }
  ...
  function onWidgetsUpdate() {
    ...
    store.setState(createInstantSearchManager_objectSpread(createInstantSearchManager_objectSpread({}, store.getState()), {}, {
      metadata: metadata,
      searching: true
  ...
  function onSearchForFacetValues(_ref5) {
    ...
    helper.searchForFacetValues(facetName, query, maxFacetHitsWithinRange).then(function (content) {
      ...
      store.setState(createInstantSearchManager_objectSpread(createInstantSearchManager_objectSpread({}, store.getState()), {}, {
        error: null,
        searchingForFacetValues: false,
        resultsFacetValues: createInstantSearchManager_objectSpread(createInstantSearchManager_objectSpread({}, store.getState().resultsFacetValues), {}, (_objectSpread7 = {}, (0,defineProperty/* default */.Z)(_objectSpread7, facetName, content.facetHits), (0,defineProperty/* default */.Z)(_objectSpread7, "query", query), _objectSpread7))
      }));
    }, function (error) {
      store.setState(createInstantSearchManager_objectSpread(createInstantSearchManager_objectSpread({}, store.getState()), {}, {
        searchingForFacetValues: false,
...
function hydrateMetadata(resultsState) {
  ...
  return resultsState.metadata.map(function (datum) {
    return createInstantSearchManager_objectSpread(createInstantSearchManager_objectSpread({
      ...
      items: datum.items && datum.items.map(function (item) {
        return createInstantSearchManager_objectSpread(createInstantSearchManager_objectSpread({
          ...
          items: item.items && item.items.map(function (nestedItem) {
            return createInstantSearchManager_objectSpread({
              value: function value() {
                return {};
              }
            }, nestedItem);
...
function InstantSearch_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { InstantSearch_ownKeys(Object(source), true).forEach(function (key) { (0,defineProperty/* default */.Z)(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { InstantSearch_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function InstantSearch_createSuper(Derived) { var hasNativeReflectConstruct = InstantSearch_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = _getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }

function InstantSearch_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var InstantSearch = /*#__PURE__*/function (_Component) {
  ...
  var _super = InstantSearch_createSuper(InstantSearch);
  ...
  _createClass(InstantSearch, [{
    ...
    key: "render",
    value: function render() {
      if (index_js_.Children.count(this.props.children) === 0) {
        return null;
      }

      return /*#__PURE__*/index_js_default().createElement(InstantSearchProvider, {
...
(0,defineProperty/* default */.Z)(InstantSearch, "defaultProps", {
  stalledSearchDelay: 200,
  refresh: false
});

(0,defineProperty/* default */.Z)(InstantSearch, "propTypes", {
...
var Index = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Index, [{
    ...
    key: "render",
    value: function render() {
      var childrenCount = index_js_.Children.count(this.props.children);

      if (childrenCount === 0) {
        return null;
      }

      return /*#__PURE__*/index_js_default().createElement(IndexProvider, {
...
(0,defineProperty/* default */.Z)(Index, "propTypes", {
  indexName: (prop_types_default()).string.isRequired,
  indexId: (prop_types_default()).string.isRequired,
  children: (prop_types_default()).node
});
...
var IndexWrapper = function IndexWrapper(props) {
  ...
  return /*#__PURE__*/index_js_default().createElement(InstantSearchConsumer, null, function (contextValue) {
    return /*#__PURE__*/index_js_default().createElement(Index, (0,esm_extends/* default */.Z)({
      contextValue: contextValue,
...
IndexWrapper.propTypes = {
  indexName: (prop_types_default()).string.isRequired,
  indexId: (prop_types_default()).string
};
var IndexComponentWithoutContext = (/* unused pure expression or super */ null && (Index));
/* harmony default export */ const widgets_Index = (IndexWrapper);
...
/* harmony default export */ const connectHits = (createConnector({
...
var createClassNames = function createClassNames(block) {
  ...
  return function () {
    ...
    return classnames_default()(suitElements);
  };
};
...
function utils_find(array, comparator) {
  if (!Array.isArray(array)) {
    return undefined;
  }
...
var Hits = function Hits(_ref) {
  ...
  return /*#__PURE__*/index_js_default().createElement("div", {
    ...
    return /*#__PURE__*/index_js_default().createElement("li", {
      className: cx('item'),
      key: hit.objectID
    }, /*#__PURE__*/index_js_default().createElement(HitComponent, {
      hit: hit
    }));
  })));
};
...
var connectConfigure_excluded = ["children", "contextValue", "indexContextValue"],
    connectConfigure_excluded2 = ["children", "contextValue", "indexContextValue"];

function connectConfigure_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function connectConfigure_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { connectConfigure_ownKeys(Object(source), true).forEach(function (key) { (0,defineProperty/* default */.Z)(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { connectConfigure_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
/* harmony default export */ const connectConfigure = (createConnector({
  ...
  getSearchParameters: function getSearchParameters(searchParameters, props) {
    var children = props.children,
        ...
        items = (0,objectWithoutProperties/* default */.Z)(props, connectConfigure_excluded);
  ...
  transitionState: function transitionState(props, prevSearchState, nextSearchState) {
    ...
    var children = props.children,
        contextValue = props.contextValue,
        indexContextValue = props.indexContextValue,
        items = (0,objectWithoutProperties/* default */.Z)(props, connectConfigure_excluded2);
    ...
    var nextValue = (0,defineProperty/* default */.Z)({}, id, connectConfigure_objectSpread(connectConfigure_objectSpread({}, omit(nextSearchState[id], nonPresentKeys)), items));
  ...
  cleanUp: function cleanUp(props, searchState) {
    ...
    var nextValue = (0,defineProperty/* default */.Z)({}, id, configureState);
...
var helpers_defineProperty = __webpack_require__(9713);
var defineProperty_default = /*#__PURE__*/__webpack_require__.n(helpers_defineProperty);
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/objectWithoutProperties.js
var helpers_objectWithoutProperties = __webpack_require__(6479);
...
;// CONCATENATED MODULE: ./node_modules/styled-components/node_modules/@emotion/memoize/dist/memoize.esm.js
function memoize(fn) {
  var cache = {};
  return function (arg) {
...
;// CONCATENATED MODULE: ./node_modules/styled-components/node_modules/@emotion/is-prop-valid/dist/is-prop-valid.esm.js
...
;// CONCATENATED MODULE: ./node_modules/@styled-icons/styled-icon/node_modules/@emotion/memoize/dist/memoize.esm.js
...
;// CONCATENATED MODULE: ./node_modules/@styled-icons/styled-icon/node_modules/@emotion/is-prop-valid/dist/is-prop-valid.esm.js


var is_prop_valid_esm_reactPropsRegex = /^((children|dangerouslySetInnerHTML|key|ref|autoFocus|defaultValue|defaultChecked|innerHTML|suppressContentEditableWarning|suppressHydrationWarning|valueLink|accept|acceptCharset|accessKey|action|allow|allowUserMedia|allowPaymentRequest|allowFullScreen|allowTransparency|alt|async|autoComplete|autoPlay|capture|cellPadding|cellSpacing|challenge|charSet|checked|cite|classID|className|cols|colSpan|content|contentEditable|contextMenu|controls|controlsList|coords|crossOrigin|data|dateTime|decoding|default|defer|dir|disabled|disablePictureInPicture|download|draggable|encType|form|formAction|formEncType|formMethod|formNoValidate|formTarget|frameBorder|headers|height|hidden|high|href|hrefLang|htmlFor|httpEquiv|id|inputMode|integrity|is|keyParams|keyType|kind|label|lang|list|loading|loop|low|marginHeight|marginWidth|max|maxLength|media|mediaGroup|method|min|minLength|multiple|muted|name|nonce|noValidate|open|optimum|pattern|placeholder|playsInline|poster|preload|profile|radioGroup|readOnly|referrerPolicy|rel|required|reversed|role|rows|rowSpan|sandbox|scope|scoped|scrolling|seamless|selected|shape|size|sizes|slot|span|spellCheck|src|srcDoc|srcLang|srcSet|start|step|style|summary|tabIndex|target|title|type|useMap|value|width|wmode|wrap|about|datatype|inlist|prefix|property|resource|typeof|vocab|autoCapitalize|autoCorrect|autoSave|color|inert|itemProp|itemScope|itemType|itemID|itemRef|on|results|security|unselectable|accentHeight|accumulate|additive|alignmentBaseline|allowReorder|alphabetic|amplitude|arabicForm|ascent|attributeName|attributeType|autoReverse|azimuth|baseFrequency|baselineShift|baseProfile|bbox|begin|bias|by|calcMode|capHeight|clip|clipPathUnits|clipPath|clipRule|colorInterpolation|colorInterpolationFilters|colorProfile|colorRendering|contentScriptType|contentStyleType|cursor|cx|cy|d|decelerate|descent|diffuseConstant|direction|display|divisor|dominantBaseline|dur|dx|dy|edgeMode|elevation|enableBackground|end|exponent|externalResourcesRequired|fill|fillOpacity|fillRule|filter|filterRes|filterUnits|floodColor|floodOpacity|focusable|fontFamily|fontSize|fontSizeAdjust|fontStretch|fontStyle|fontVariant|fontWeight|format|from|fr|fx|fy|g1|g2|glyphName|glyphOrientationHorizontal|glyphOrientationVertical|glyphRef|gradientTransform|gradientUnits|hanging|horizAdvX|horizOriginX|ideographic|imageRendering|in|in2|intercept|k|k1|k2|k3|k4|kernelMatrix|kernelUnitLength|kerning|keyPoints|keySplines|keyTimes|lengthAdjust|letterSpacing|lightingColor|limitingConeAngle|local|markerEnd|markerMid|markerStart|markerHeight|markerUnits|markerWidth|mask|maskContentUnits|maskUnits|mathematical|mode|numOctaves|offset|opacity|operator|order|orient|orientation|origin|overflow|overlinePosition|overlineThickness|panose1|paintOrder|pathLength|patternContentUnits|patternTransform|patternUnits|pointerEvents|points|pointsAtX|pointsAtY|pointsAtZ|preserveAlpha|preserveAspectRatio|primitiveUnits|r|radius|refX|refY|renderingIntent|repeatCount|repeatDur|requiredExtensions|requiredFeatures|restart|result|rotate|rx|ry|scale|seed|shapeRendering|slope|spacing|specularConstant|specularExponent|speed|spreadMethod|startOffset|stdDeviation|stemh|stemv|stitchTiles|stopColor|stopOpacity|strikethroughPosition|strikethroughThickness|string|stroke|strokeDasharray|strokeDashoffset|strokeLinecap|strokeLinejoin|strokeMiterlimit|strokeOpacity|strokeWidth|surfaceScale|systemLanguage|tableValues|targetX|targetY|textAnchor|textDecoration|textRendering|textLength|to|transform|u1|u2|underlinePosition|underlineThickness|unicode|unicodeBidi|unicodeRange|unitsPerEm|vAlphabetic|vHanging|vIdeographic|vMathematical|values|vectorEffect|version|vertAdvY|vertOriginX|vertOriginY|viewBox|viewTarget|visibility|widths|wordSpacing|writingMode|x|xHeight|x1|x2|xChannelSelector|xlinkActuate|xlinkArcrole|xlinkHref|xlinkRole|xlinkShow|xlinkTitle|xlinkType|xmlBase|xmlns|xmlnsXlink|xmlLang|xmlSpace|y|y1|y2|yChannelSelector|z|zoomAndPan|for|class|autofocus)|(([Dd][Aa][Tt][Aa]|[Aa][Rr][Ii][Aa]|x)-.*))$/; // https://esbench.com/bench/5bfee68a4cd7e6009ef61d23

var is_prop_valid_esm_index = dist_memoize_esm(function (prop) {
  return is_prop_valid_esm_reactPropsRegex.test(prop) || prop.charCodeAt(0) === 111
  /* o */
  && prop.charCodeAt(1) === 110
  /* n */
  && prop.charCodeAt(2) < 91;
...
/* harmony default export */ const dist_is_prop_valid_esm = (is_prop_valid_esm_index);

;// CONCATENATED MODULE: ./node_modules/@styled-icons/styled-icon/index.esm.js
...
function index_esm_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { index_esm_ownKeys(Object(source), true).forEach(function (key) { defineProperty_default()(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { index_esm_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
function isValidProp(key) {
  return dist_is_prop_valid_esm(key);
}
...
var StyledIconBaseBase = /*#__PURE__*/index_js_.forwardRef(function (props, ref) {
  var children = props.children,
      ...
      size = props.size,
      title = props.title,
      otherProps = objectWithoutProperties_default()(props, ["children", "iconAttrs", "iconVerticalAlign", "iconViewBox", "size", "title"]);

  var iconProps = index_esm_objectSpread({
    viewBox: iconViewBox,
  ...
  return /*#__PURE__*/index_js_.createElement("svg", extends_default()({}, iconProps, svgProps, {
    ref: ref
  }), title && /*#__PURE__*/index_js_.createElement("title", {
    key: "icon-title"
  }, title), children);
});
var StyledIconBase = /*#__PURE__*/styled_components_esm(StyledIconBaseBase).withConfig({
...
;// CONCATENATED MODULE: ./node_modules/@styled-icons/fa-brands/Algolia/Algolia.esm.js



var Algolia = /*#__PURE__*/index_js_.forwardRef(function (props, ref) {
  var attrs = {
    "fill": "currentColor",
    "xmlns": "http://www.w3.org/2000/svg"
  };
  return /*#__PURE__*/index_js_.createElement(StyledIconBase, extends_default()({
    iconAttrs: attrs,
...
;// CONCATENATED MODULE: ./src/components/search/styles.js
const PoweredBy=()=>(0,emotion_react_esm/* jsx */.tZ)("span",{className:"poweredBy"},"Powered by",` `,(0,emotion_react_esm/* jsx */.tZ)("a",{href:"https://algolia.com"},(0,emotion_react_esm/* jsx */.tZ)(Algolia,{size:"1em"})," Algolia"));
;// CONCATENATED MODULE: ./node_modules/@styled-icons/fa-solid/Search/Search.esm.js



var Search = /*#__PURE__*/index_js_.forwardRef(function (props, ref) {
  var attrs = {
    "fill": "currentColor",
    "xmlns": "http://www.w3.org/2000/svg"
  };
...
function _refine(props, searchState, nextRefinement, context) {
  ...
  var nextValue = (0,defineProperty/* default */.Z)({}, id, nextRefinement);
...
/* harmony default export */ const connectSearchBox = (createConnector({
...
const input_excluded=["refine"];function _EMOTION_STRINGIFIED_CSS_ERROR__(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const SearchIcon=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(Search, true?{target:"e1hfqph42"}:0)( true?{name:"cqufu4",styles:"width:1em;pointer-events:none;margin-right:10px;position:absolute;left:15px;color:#2fd2c5"}:0);const input_focus=props=>/*#__PURE__*/css("background:white;color:",props=>props.theme.darkBlue,";cursor:text;width:5em;+",SearchIcon,"{color:",props=>props.theme.darkBlue,";margin:0.3em;}"+( true?"":0), true?"":0);const collapse=props=>/*#__PURE__*/css("width:0;cursor:pointer;color:",props=>props.theme.lightBlue,";+",SearchIcon,"{color:white;}",props=>props.focus&&input_focus()," margin-left:",props=>props.focus?`-1.6em`:`-1em`,";padding-left:",props=>props.focus?`1.6em`:`1em`,";::placeholder{color:",props=>props.theme.gray,";}"+( true?"":0), true?"":0);const expand=props=>/*#__PURE__*/css("background:",props=>props.theme.veryLightGray,";width:6em;margin-left:-1.6em;padding-left:1.6em;+",SearchIcon,"{margin:0.3em;}"+( true?"":0), true?"":0);const collapseExpand=props=>/*#__PURE__*/css(props=>props.collapse?collapse():expand(),";"+( true?"":0), true?"":0);const Input=(0,emotion_styled_base_esm/* default */.Z)("input", true?{target:"e1hfqph41"}:0)("outline:none;border:none;font-size:1em;background:white;transition:",props=>props.theme.shortTrans,";border-radius:",props=>props.theme.smallBorderRadius,";{}"+( true?"":0));const Form=(0,emotion_styled_base_esm/* default */.Z)("form", true?{target:"e1hfqph40"}:0)( true?{name:"pxthj4",styles:"display:flex;align-items:center;@media only screen and (max-width: 767px){width:100%;margin-left:15px;}"}:0);/* harmony default export */ const input = (connectSearchBox(_ref=>{let{refine}=_ref,rest=(0,objectWithoutProperties/* default */.Z)(_ref,input_excluded);const preventSubmit=e=>{e.preventDefault();};return (0,emotion_react_esm/* jsx */.tZ)(Form,{className:'formElement',onSubmit:preventSubmit},(0,emotion_react_esm/* jsx */.tZ)(SearchIcon,null),(0,emotion_react_esm/* jsx */.tZ)(Input,(0,esm_extends/* default */.Z)({className:'searchInput ',type:"text",placeholder:"Search","aria-label":"Search",onChange:e=>refine(e.target.value)},rest)));}));
;// CONCATENATED MODULE: ./node_modules/react-instantsearch-core/dist/es/connectors/connectHighlight.js
...
/* harmony default export */ const connectHighlight = (createConnector({
...
;// CONCATENATED MODULE: ./node_modules/react-instantsearch-dom/dist/es/components/Highlighter.js
...
var Highlight = function Highlight(_ref) {
  ...
  return /*#__PURE__*/index_js_default().createElement(TagName, {
...
Highlight.propTypes = {
  ...
  isHighlighted: (prop_types_default()).bool.isRequired,
  highlightedTagName: (prop_types_default()).string.isRequired,
  ...
  return /*#__PURE__*/index_js_default().createElement("span", {
    ...
    if (Array.isArray(item)) {
      ...
      return /*#__PURE__*/index_js_default().createElement("span", {
        ...
        return /*#__PURE__*/index_js_default().createElement(Highlight, {
          cx: cx,
          key: index,
          value: element.value,
      ...
      }), !isLast && /*#__PURE__*/index_js_default().createElement("span", {
...
Highlighter.propTypes = {
  cx: (prop_types_default()).func.isRequired,
  hit: (prop_types_default()).object.isRequired,
  attribute: prop_types_default().oneOfType([prop_types_default().arrayOf((prop_types_default()).string), (prop_types_default()).string]).isRequired,
  highlight: (prop_types_default()).func.isRequired,
  highlightProperty: (prop_types_default()).string.isRequired,
  tagName: (prop_types_default()).string,
  nonHighlightedTagName: (prop_types_default()).string,
  className: (prop_types_default()).string,
...
/* harmony default export */ const components_Highlighter = (Highlighter);
;// CONCATENATED MODULE: ./node_modules/react-instantsearch-dom/dist/es/components/Highlight.js




var Highlight_cx = createClassNames('Highlight');

var Highlight_Highlight = function Highlight(props) {
  return /*#__PURE__*/index_js_default().createElement(components_Highlighter, (0,esm_extends/* default */.Z)({}, props, {
    highlightProperty: "_highlightResult",
    cx: Highlight_cx
  }));
};

/* harmony default export */ const components_Highlight = (Highlight_Highlight);
...
/* harmony default export */ const widgets_Highlight = (connectHighlight(components_Highlight));
;// CONCATENATED MODULE: ./node_modules/react-instantsearch-dom/dist/es/components/Snippet.js




var Snippet_cx = createClassNames('Snippet');
...
/* harmony default export */ const widgets_Snippet = (connectHighlight(components_Snippet));
// EXTERNAL MODULE: ./.cache/gatsby-browser-entry.js + 4 modules
var gatsby_browser_entry = __webpack_require__(2031);
;// CONCATENATED MODULE: ./src/components/search/hitComps.js
const PageHit=clickHandler=>({hit})=>(0,emotion_react_esm/* jsx */.tZ)("div",null,(0,emotion_react_esm/* jsx */.tZ)(gatsby_browser_entry.Link,{to:hit.slug,onClick:clickHandler},(0,emotion_react_esm/* jsx */.tZ)("div",null,(0,emotion_react_esm/* jsx */.tZ)(widgets_Highlight,{attribute:"title",hit:hit,tagName:"mark"}))),(0,emotion_react_esm/* jsx */.tZ)(widgets_Snippet,{attribute:"excerpt",hit:hit,tagName:"mark"}));
;// CONCATENATED MODULE: ./src/components/search/index.js
function search_EMOTION_STRINGIFIED_CSS_ERROR_(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const search_SearchIcon=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(Search, true?{target:"e2cy63l2"}:0)( true?{name:"q8zv7r",styles:"width:1em;pointer-events:none"}:0);const HitsWrapper=(0,emotion_styled_base_esm/* default */.Z)("div", true?{target:"e2cy63l1"}:0)("display:",props=>props.show?`grid`:`none`,";max-height:80vh;overflow:scroll;z-index:2;-webkit-overflow-scrolling:touch;position:absolute;right:0;top:calc(100% + 0.5em);width:80vw;max-width:30em;box-shadow:0 0 5px 0;padding:0.7em 1em 0.4em;background:white;@media only screen and (max-width: 991px){width:400px;max-width:400px;}@media only screen and (max-width: 767px){width:100%;max-width:500px;}border-radius:",props=>props.theme.smallBorderRadius,";>*+*{padding-top:1em!important;border-top:2px solid ",props=>props.theme.darkGray,";}li+li{margin-top:0.7em;padding-top:0.7em;border-top:1px solid ",props=>props.theme.lightGray,";}*{margin-top:0;padding:0;color:black!important;}ul{list-style:none;}mark{color:",props=>props.theme.lightBlue,";background:",props=>props.theme.darkBlue,";}header{display:flex;justify-content:space-between;margin-bottom:0.3em;h3{color:black;background:",props=>props.theme.gray,";padding:0.1em 0.4em;border-radius:",props=>props.theme.smallBorderRadius,";}}h3{color:black;margin:0 0 0.5em;}h4{color:black;margin-bottom:0.3em;}"+( true?"":0));const Root=(0,emotion_styled_base_esm/* default */.Z)("div", true?{target:"e2cy63l0"}:0)( true?{name:"3z7g5g",styles:"position:relative;display:grid;grid-gap:1em;@media only screen and (max-width: 767px){width:100%;}"}:0);const Results=connectStateResults(({searching,searchState:state,searchResults:res})=>searching&&`Searching...`||res&&res.nbHits===0&&`No results for '${state.query}'`);const useClickOutside=(ref,handler,events)=>{if(!events)events=[`mousedown`,`touchstart`];const detectClickOutside=event=>ref&&ref.current&&!ref.current.contains(event.target)&&handler();(0,index_js_.useEffect)(()=>{for(const event of events)document.addEventListener(event,detectClickOutside);return()=>{for(const event of events)document.removeEventListener(event,detectClickOutside);};});};const searchClient=algoliasearch_default()((config_default()).header.search.algoliaAppId,(config_default()).header.search.algoliaSearchKey);function SearchComponent({indices,collapse,hitsAsGrid}){const ref=/*#__PURE__*/(0,index_js_.createRef)();const{0:query,1:setQuery}=(0,index_js_.useState)(``);const{0:focus,1:setFocus}=(0,index_js_.useState)(false);useClickOutside(ref,()=>setFocus(false));const displayResult=query.length>0&&focus?'showResults':'hideResults';return (0,emotion_react_esm/* jsx */.tZ)(widgets_InstantSearch,{searchClient:searchClient,indexName:indices[0].name,onSearchStateChange:({query})=>setQuery(query),root:{Root,props:{ref}}},(0,emotion_react_esm/* jsx */.tZ)(input,{onFocus:()=>setFocus(true),collapse,focus}),(0,emotion_react_esm/* jsx */.tZ)(HitsWrapper,{className:'hitWrapper '+displayResult,show:query.length>0&&focus,asGrid:hitsAsGrid},indices.map(({name,title,hitComp,type})=>{return (0,emotion_react_esm/* jsx */.tZ)(widgets_Index,{key:name,indexName:name},(0,emotion_react_esm/* jsx */.tZ)(Results,null),(0,emotion_react_esm/* jsx */.tZ)(widgets_Hits,{hitComponent:hitComps_namespaceObject[hitComp](()=>setFocus(false))}));}),(0,emotion_react_esm/* jsx */.tZ)(PoweredBy,null)),(0,emotion_react_esm/* jsx */.tZ)(Configure,{hitsPerPage:5}));}
